...
class Manager_base
{
     ...
     * @return mixed
     */
	//public function connect($host="mysql13.000webhost.com", $user="a5186601_project", $paswd="coucou25", $db="a5186601_project")
    //public function connect($host="sql4.freemysqlhosting.net", $user="sql4103734", $paswd="s81z9hm929", $db="sql4103734")
    ...
    {
        throw new $this->conn->connect_error;
    }
	...
	public function takeLastId($table, $nameId){
	    $sql = "SELECT max({$nameId}) as `id` FROM {$table}";
        $data = $this->fetchOne($sql);
        if(empty($data['id'])) {
            return 0;
        }
